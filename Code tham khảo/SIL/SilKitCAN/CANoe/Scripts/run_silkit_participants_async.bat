...
START "sil-kit-participant-engine" "%SCRIPT_DPATH%\..\..\SilKit\bin\SUT_Engine.exe" Engine --async
START "sil-kit-participant-lights" "%SCRIPT_DPATH%\..\..\SilKit\bin\SUT_Lights.exe" Lights --async
